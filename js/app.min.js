// Делаем анимацию элементов при скролле
...
let slider_programms = new Swiper('.slider-programms__body', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
let slider_certificates = new Swiper('.slider-certificate__body', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.slider-certificate__arrow_next',
		prevEl: '.slider-certificate__arrow_prev',
	},
	breakpoints: {
		320: {
			slidesPerView: 1,
